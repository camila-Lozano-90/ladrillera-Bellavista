...
<main class="col-md-12" style="background-color: white;height:auto;">
    <div class="container-fluid">
        <div style="background-color: #FF6800;" class="card-header bg-gradient text-white">
            <h5>Primera en Despacho</h5>
        </div>
        <div class="col-md-12">
            <div class="card">
                <form id="frmPrimeraDespacho">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Fecha:</label>
                                    <input type="date" name="fecha1" id="fecha1" class="form-control form-control-sm" aria-describedby="helpId" required>
                                </div>
                            </div>
                            <div class="col-md-5" style="display:inline-block;">
                                ...
                                <div class="input-group form-group" style="padding-top:0%;padding-left:1%;margin-top:0%;margin-bottom:2%;">
                                    <input id="responsableDiario" name="responsableDiario" type="text" class="form-control" placeholder="Buscar...">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered table-sm table-hover" id="tblReferencias1">
...
<script src="<?php echo URLROOT; ?>js/primeraDespacho.js"></script>
