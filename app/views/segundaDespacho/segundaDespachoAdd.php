...
<main class="col-md-12" style="background-color: white;height:auto;">
    <div class="container-fluid">
        <div style="background-color: #FF6800;" class="card-header bg-gradient text-white">
            <h5>Segunda en Despacho</h5>
        </div>

        <div class="col-md-12">
            <div class="card">
                <form id="frmSegundaDespacho">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Fecha:</label>
                                    <input type="date" name="fecha2" id="fecha2" class="form-control form-control-sm" aria-describedby="helpId" required>
                                </div>
                            </div>
                            <div class="col-md-5" style="display:inline-block;">
                                ...
                                <div class="input-group form-group" style="padding-top:0%;padding-left:1%;margin-top:0%;margin-bottom:2%;">
                                    <input id="responsableDiario2" name="responsableDiario2" type="text" class="form-control" placeholder="Buscar...">
                                    <button id="buscarResp2" class="btn" type="button" style="background-color: #FF6800;color: white;" data-bs-toggle="modal" data-bs-target="#items2"><span class="bi bi-search"></span></button>
                                </div>
                            </div>
                            <div class="col-md-5" style="display:inline-block;">
                                <label for="" style="margin-top: 1%;" class="form-label">Referencia:</label>
                                <div class="input-group form-group" style="padding-top:0%;padding-left:1%;margin-top:0%;margin-bottom:2%;">
                                    <input id="referencial2" name="referencial2" type="text" class="form-control" placeholder="Buscar..." required>
                                    <button id="buscarRef" class="btn" type="button" style="background-color: #FF6800;color: white;" data-bs-toggle="modal" data-bs-target="#items4"><span class="bi bi-search"></span></button>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            ...
                            <input value="Enviar" type="submit" style="background-color: #FF5733 ; color:#ffffff;" class="btn  btn-sm ms-1" name="btnGuardar2" id="btnGuardar2">
...
<!-- Modal Items-->
<div class="modal fade" id="items4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-sm table-hover" id="tblReferencias2">
...
<script src="<?php echo URLROOT; ?>js/segundaDespacho.js"></script>
